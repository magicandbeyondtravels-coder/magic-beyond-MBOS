...
`ideal-client.md` was migrated from `core/` on 2026-07-04 — persona-type objects belong here per the type registry, not in core. Its `id` was not changed on the move, per ARCHITECTURE.md section 6.1. `customer-journey.md` is now the active, canonical source for the ten journey stage names; other domains should reference it rather than restate the stages from README.md's prose.

| File | Title | Type | Status |
| --- | --- | --- | --- |
| [ideal-client.md](ideal-client.md) | Ideal Client | persona | active |
| [customer-journey.md](customer-journey.md) | Customer Journey | reference | active |
